            ...
            <div className="my-20 mx-40 py-10 px-10 bg-[#FDFDFD] rounded-[24px] font-poppins">
                ...
                <div className="container mx-auto pl-20 w-2/3">
                    ...
                    <div className="mx-auto w-1/2 mt-10">
                        <button className="font-bold bg-[#98A8F8] text-[#F9F9F9] py-[16px] px-[24px] rounded-[8px] transition ease-in-out duration-300 hover:bg-[#737EDE] hover:drop-shadow-lg">
                            <a href="#">Mulai Diagnosa <span><NavigateNextIcon/></span></a>
                        </button>
                    </div>
                </div>
            </div>
