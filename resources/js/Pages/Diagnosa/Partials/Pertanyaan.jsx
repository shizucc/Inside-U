export default function Pertanyaan(props) {
    ...
    return(
        ...
        <ul className="grid w-full gap-6 md:grid-cols-2">
            <li key={id_yes} className="ml-80 w-1/2">
                ...
                <label htmlFor={id_yes} className="inline-flex items-center justify-between w-1/2 h-8 p-5 text-[#5F93D0] bg-white border-4 border-[#5F93D0] rounded-2xl cursor-pointer peer-checked:bg-[#5F93D0] peer-checked:text-white hover:text-gray-600 hover:bg-gray-200">
                    <div className="w-full mx-auto text-lg text-center font-semibold">Ya</div>
                </label>
            </li>
            <li key={id_no} className="ml-0 w-1/2">
                ...
                <label htmlFor={id_no} className="inline-flex items-center justify-between w-1/2 h-8 p-5 text-[#FF0000] bg-white border-4 border-[#FF0000] rounded-2xl cursor-pointer peer-checked:bg-[#FF0000] peer-checked:text-white hover:text-gray-600 hover:bg-gray-200">
